...
<tr><td>Display Name</td>
    <td colspan="3">{{$item->display_name}}</td></tr>
       ...
       <Tr> <td>Feature Bullets</td><td colspan="3">@if($item->content != null){{$item->content->feature_bullets}}@endif</td></tr>
        ...
        @if($item->image)
        @if($item->image->main)<tr><td>Main Image: </td><td colspan="3"><a href="{{$item->image->main}}" target="_new"><img style="width:250px;" src="{{$item->image->main}}"><br>{{$item->image->main}}</a></td></tr> @endif
        @if($item->image->alt1 != null)<tr><td>Alt Image 1: </td><td colspan="3"><a href="{{$item->image->alt1}}" target="_new"><img style="width:250px;" src="{{$item->image->alt1}}"><br>{{$item->image->alt1}}</a></td></tr>@endif
        @if($item->image->alt2 != null) <tr><td>Alt Image 2: </td><td colspan="3"><a href="{{$item->image->alt2}}" target="_new"><img style="width:250px;" src="{{$item->image->alt2}}"><br>{{$item->image->alt2}}</a></td></tr>@endif
        @if($item->image->alt3 != null) <tr><td>Alt Image 3: </td><td colspan="3"><a href="{{$item->image->alt3}}" target="_new"><img style="width:250px;" src="{{$item->image->alt3}}"><br>{{$item->image->alt3}}</a></td></tr>@endif
        @if($item->image->alt4 != null)<tr><td>Alt Image 4: </td><td colspan="3"><a href="{{$item->image->alt4}}" target="_new"><img style="width:250px;" src="{{$item->image->alt4}}"><br>{{$item->image->alt4}}</a></td></tr>@endif
            @endif
        @if($item->meta)
